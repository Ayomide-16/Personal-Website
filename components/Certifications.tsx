...
const Certifications: React.FC = () => {
    return (
        <section id="certifications" className="py-12 scroll-mt-16 border-b border-gray-200/60">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {CERTIFICATIONS.map((cert, index) => (
                        <a
                            ...
                            className="group relative flex flex-col h-full rounded-2xl border border-gray-200/60 bg-white/30 backdrop-blur-[2px] p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-gray-300/80 hover:bg-white/50"
                        >
